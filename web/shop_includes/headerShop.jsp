            ...
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold">
                        <span class="text-primary font-weight-bold border px-3 mr-1">Kittens</span>Bookstore
                    </h1>
                </a>
            </div>
            
            <div class="col-lg-6 col-6 text-left">
                <form onsubmit="event.preventDefault(); searchByKeyWord();" style="margin-left: 75px;">
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="header-support d-none d-md-flex align-items-center">
                        <div class="header-support__icon">
                            <img src="images/tvbh.jpg" alt="phone">
                        </div>
